...
load(":defs.bzl", "ActionsInfo", "attach_upb_aspect")
...
def _test_rust_compilation_action_has_runtime_as_input():
    ...
    attach_upb_aspect(name = "some_proto_with_aspect", dep = ":some_proto")
...
def _test_rust_compilation_action_has_deps_as_input():
    attach_upb_aspect(name = "child_proto_with_aspect", dep = ":child_proto")
